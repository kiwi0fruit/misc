...
| ы,й      | `ый(?=[_\c\W])`       | `yj`                | бел**ый**/bel**yj**, бел**ый**с/bel**yj**s, л**ый**ес/l**yj**es       |
...
| й        | `(?<!й)й(?=[_\W])`    | `j`                 |          |
| й        | `й`                   | `jj`                | **йй**/**jjjj**, под**й**ес/pod**jj**es, под**й**од/pod**jj**od, бел**ый**а/bel**yjj**a, бел**ый**е/bel**yjj**e |
|          | `ё`                   | `yo`                |          |
|          | `ю`                   | `yu`                |          |
|          | `я`                   | `ya`                |          |
|          | `ж`                   | `zh`                |          |
