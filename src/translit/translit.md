...
| e/je/ě/ê | jo/ǒ/ô | ž  | i/ji/ǐ/î | j/jj | h/ĥ/qh  | č  | š  | ŝĉ   | j/ŵ  | y/yy | j/ĵ  | eh | ju/ǔ/û | ja/ǎ/â |
...
| ъ/wh   | `ъ`                   | `wh`                | он**ъ**/on**wh**, Му**ъ**минат/Mu**wh**minat, Чан**ъ**ань/Chan**wh**anj, Мур**ъйи**н/Mur**whji**n |
...
| х/kh   | `(?=[хтсшзжцчщъьеэй])х` | `kh`              | с**х**од/s**kh**od, ме**х**/me**kh**, мэр/mehr, эхо/eh**kh**o, эон/ehon, Муръ**х**ин/Murwh**kh**in, Мурь**х**ин/Murj**kh**in, от**х**од/ot**kh**od |
| х/h    | `х`                   | `h`                 | **х**о**х**олок/**h**o**h**olok, в**ы**ход/v**y**hod, **х**ья/**h**jya, **х**ьан/**h**jhan |
| е/e    | `е`                   | `e`                 | в**е**к/v**e**k                                                       |
| ё/yo   | `ё`                   | `yo`                | **ё**мко/**yo**mko, м**ё**д/m**yo**d                                  |
| ж/zh   | `ж`                   | `zh`                | ё**ж**/yo**zh**                                                       |
| и/i    | `и`                   | `i`                 | м**и**г/m**i**g                                                       |
| щ/schh | `щ`                   | `schh`              | **щ**ётка/**schh**yotka, **cч**ётка/**sch**yotka, **шч**ётка/**shch**yotka |
