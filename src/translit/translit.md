...
| х/kh   | `х`                   | `kh`                | с**х**од/s**kh**od, ме**х**/me**kh**, мэр/mehr, эхо/eh**kh**o, эон/ehon, Муръ**х**ин/Murwh**kh**in, Мурь**х**ин/Murj**kh**in |
| х/h    | `(?=[зсхцчжшщьей])х`  | `h`                 | **х**о**х**олок/**h**o**h**olok, **х**ья/**h**jya, **х**ьан/**h**jhan |
